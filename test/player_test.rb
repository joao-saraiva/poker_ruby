...
class PlayerTest < MiniTest::Test
  ...
  def test_straight_hand
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.straight_hand?, true)
  end
  ...
  def test_straight_hand_false
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.straight_hand?, false)
  end
  ...
  def test_flush_hand
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.flush_hand?, true)
  end
  ...
  def test_flush_hand_false
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.flush_hand?, false)
  end
  ...
  def test_full_house_hand
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.full_house_hand?, true)
  end
  ...
  def test_full_house_hand_false
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.full_house_hand?, false)
  end
  ...
  def test_four_of_kind_hand
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.four_of_kind_hand?, true)
  end
  ...
  def test_four_of_kind_hand_false
    ...
    card2 = Card.new("\u2660", '3')
    player.receive_cards([card, card2])
    assert_equal(player.four_of_kind_hand?, false)
  end
